...
![plugins.png]({{base}}/assets/imgs/codenvy/integration-guide/continuous-integration/plugins.png)
...
![postbuild.png]({{base}}/assets/imgs/codenvy/integration-guide/continuous-integration/postbuild.png)

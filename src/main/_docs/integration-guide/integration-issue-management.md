...
![ProductInteractionFlowswithContinousDevelopment(1).svg]({{base}}/assets/imgs/codenvy/integration-guide/issue-management/ProductInteractionFlowswithContinousDevelopment(1).svg)
...
![JIRAplugin-DevelopandReviewinIDE(1).svg]({{base}}/assets/imgs/codenvy/integration-guide/issue-management/JIRAplugin-DevelopandReviewinIDE(1).svg)
...
![AgileWorkflowArchitecture-MicrosoftVSTS-Phase1.png]({{base}}/assets/imgs/codenvy/integration-guide/issue-management/AgileWorkflowArchitecture-MicrosoftVSTS-Phase1.png)
...
![VSTSextension-DevelopandReviewinIDE.png]({{base}}/assets/imgs/codenvy/integration-guide/issue-management/VSTSextension-DevelopandReviewinIDE.png)
